...
import com.training.dataproviders.ContactFormDataProviderForWrongValue;
import com.training.generics.ScreenShot;
import com.training.pom.IncorrectContactFormPOM;
import com.training.utility.DriverFactory;
import com.training.utility.DriverNames;

public class SendWrongValueInContactForm {
	private WebDriver driver;
	private String baseUrl;
	private IncorrectContactFormPOM contactPOM;
	...
	public void setUp() throws Exception {
		...
		contactPOM = new IncorrectContactFormPOM(driver);
	...
	@Test(dataProvider = "excel-inputs", dataProviderClass = ContactFormDataProviderForWrongValue.class)
	public void loginDBTest(String Name, String Email, String Subject, String Message ) {
		...
		String ErrorResult = contactPOM.ErrorCheck();
		System.out.println("ErrorResult is:" + ErrorResult);
