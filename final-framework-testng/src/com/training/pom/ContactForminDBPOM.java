...
public class ContactForminDBPOM {
private WebDriver driver; 
	
	public ContactForminDBPOM(WebDriver driver) {
		this.driver = driver; 
	...
	@FindBy(xpath = "/html/body/div[1]/div[5]/div/div[2]/div[1]/div[2]/div/div[2]/form/div[2]")
	...
	public void WaitForMessage () {
		...
		wait1.until(ExpectedConditions.elementToBeClickable(WaitMessage)); 
